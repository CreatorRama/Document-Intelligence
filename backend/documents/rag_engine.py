...
class RAGEngine:
    ...
    def chunk_text(self, text: str, chunk_size: int = 500, overlap: int = 50) -> List[str]:
        ...
        return chunks if chunks else [text]  # Return original text if all methods fail
    ...
    def _chunk_by_words(self, text: str, chunk_size: int, overlap: int) -> List[str]:
        ...
        words_per_chunk = max(50, chunk_size // 6)  # Rough estimate: 6 chars per word
    ...
    def store_document_embeddings(self, document: Document, chunks: List[str]) -> None:
        ...
        try:
            ...
            print(f"Successfully stored {len(chunks)} chunks for document {document.id}")
        except Exception as e:
